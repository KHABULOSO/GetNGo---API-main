...
class DishesController {
    async create(request, response) {
        ...
        // Checking if dish already exists in the database
        ...
        const dish_id = await knex("dishes").insert({
            ...
            description,
            price,
            category, // Keeping original categories like dishes, drinks, desserts
        });
    ...
    async update(request, response) {
        ...
        const filename = imageFileName ? await diskStorage.saveFile(imageFileName) : dish.image;
        ...
        // Updating the dish info through the informed ID
